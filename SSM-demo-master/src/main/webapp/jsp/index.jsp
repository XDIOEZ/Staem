...
<%--<form action="${pageContext.request.contextPath}/user/checkUser.do" method="post">--%>
    <table>
        ...
        <tr>
            ...
            <td>
                <input id="Register" type="button" value="注册"  onclick="window.location.href='userRig.jsp'">
                <%--<input id="Register" type="submit" value="Register"  onclick="window.location.href='userRig.jsp'">--%>

            </td>
            <td>
                <input id="Register" type="button" value="管理员页面"  onclick="window.location.href='login.jsp'">
                <%--<input id="Register" type="submit" value="Register"  onclick="window.location.href='userRig.jsp'">--%>
